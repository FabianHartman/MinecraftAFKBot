package fabian.hartman.MinecraftAFKBot.bot.registry.legacy;
...
public enum LegacyMaterial {
    ...
    LegacyMaterial(final int id) {
        this(id, 64);
    }

    LegacyMaterial(final int id, final int stack) {
        this(id, stack, 1);
    }

    LegacyMaterial(final int id, final int stack, final int durability) {
        this.id = id;
