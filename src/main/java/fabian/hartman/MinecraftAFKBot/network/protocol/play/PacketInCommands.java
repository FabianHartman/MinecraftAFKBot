...
import fabian.hartman.MinecraftAFKBot.modules.command.brigardier.argument.*;
import lombok.Getter;
import lombok.NoArgsConstructor;
import fabian.hartman.MinecraftAFKBot.MinecraftAFKBot;
import fabian.hartman.MinecraftAFKBot.event.play.CommandsRegisteredEvent;
import fabian.hartman.MinecraftAFKBot.modules.command.brigardier.CommandNodeData;
import fabian.hartman.MinecraftAFKBot.modules.command.brigardier.CommandTree;
import fabian.hartman.MinecraftAFKBot.modules.command.brigardier.node.ArgumentNode;
import fabian.hartman.MinecraftAFKBot.modules.command.brigardier.node.LiteralNode;
...
public class PacketInCommands extends Packet {
    ...
    public void read(ByteArrayDataInputWrapper in, NetworkHandler networkHandler, int length, int protocolId) throws IOException {
        ...
        MinecraftAFKBot.getInstance().getCurrentBot().getEventManager().callEvent(new CommandsRegisteredEvent(commandDispatcher));
