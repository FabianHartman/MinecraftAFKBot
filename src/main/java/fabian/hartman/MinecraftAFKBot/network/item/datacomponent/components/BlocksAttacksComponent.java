...
import fabian.hartman.MinecraftAFKBot.network.item.datacomponent.components.parts.blocksattacks.DamageReduction;
import fabian.hartman.MinecraftAFKBot.network.item.datacomponent.components.parts.blocksattacks.ItemDamageFunction;
